...
import { addFrequency, monthBounds, zonedDateKey } from "./dates";
...
describe("zoned date keys", () => {
  it("buckets an instant using the user timezone, not UTC date", () => {
    expect(zonedDateKey("2026-07-31T18:30:00.000Z", "Asia/Kolkata")).toBe("2026-08-01");
    expect(zonedDateKey("2026-07-31T18:29:00.000Z", "Asia/Kolkata")).toBe("2026-07-31");
  });
});
