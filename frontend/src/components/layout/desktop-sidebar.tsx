        ...
        {desktopNavigation.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "nav-link flex min-h-[58px] items-center gap-3 rounded-2xl border border-transparent px-3 py-2.5 text-start text-[13px] font-bold text-[var(--muted-foreground)] transition",
                active
